...
@section('contenu')
    ...
    <div class="row mt-5 mb-5">
        <div class="col-md-12 space">
            <div><h4>Modification d'un métier</h4></div>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
            <form action="{{ route('metier.update', $metier->id) }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="libelle" name="libelle"
                           ...
                           value="{{ old('libelle', $metier->libelle) }}" placeholder="Libellé du métier">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="slug" name="slug"
                           ...
                           value="{{ old('slug', $metier->slug) }}" placeholder="Slug du métier">
